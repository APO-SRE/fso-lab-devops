...
d_completion_release="${d_completion_release:-20.10.13}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="20.10.13"              # [optional] docker completion for bash release (defaults to '20.10.13').
