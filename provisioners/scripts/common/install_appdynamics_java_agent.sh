...
appd_java_agent_release="${appd_java_agent_release:-21.11.2.33305}"
appd_java_agent_sha256="${appd_java_agent_sha256:-2e50bc70eefa9a677ae7c0cc49c6d4c84886f212dc991e3a0d01fc6634010970}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="21.11.2.33305"               # [optional] java agent release (defaults to '21.11.2.33305').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="2e50bc70eefa9a677ae7c0cc49c6d4c84886f212dc991e3a0d01fc6634010970"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver21.11.2.33305/conf/controller-info.xml'
