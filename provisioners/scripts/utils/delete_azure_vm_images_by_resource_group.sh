#!/bin/sh
#---------------------------------------------------------------------------------------------------
# Delete the FSO Lab DevOps project-specific Azure Images's by resource group.
#
...
appd_project_image_types="${appd_project_image_types-FSO-Lab-VM-CentOS}"
azurerm_resource_group_name="${azurerm_resource_group_name-FSO-Lab-DevOps-Images}"
