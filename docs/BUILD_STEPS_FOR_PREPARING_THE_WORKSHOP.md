...
1.	Install the [Homebrew 4.0.29](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
5.	Install [Terraform 1.5.3](https://www.terraform.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    sudo wget https://releases.hashicorp.com/terraform/1.5.3/terraform_1.5.3_linux_amd64.zip
    sudo unzip terraform_1.5.3_linux_amd64.zip
    sudo rm -i terraform_1.5.3_linux_amd64.zip
    ```
