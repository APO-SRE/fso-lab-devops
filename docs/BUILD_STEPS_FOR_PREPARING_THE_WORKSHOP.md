...
4.	Install [Terraform 1.1.1](https://www.terraform.io/downloads.html) for macOS 64-bit.  
    ```bash
    $ brew tap hashicorp/tap
...
3.	Install [Terraform 1.1.1](https://releases.hashicorp.com/terraform/1.1.1/terraform_1.1.1_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
