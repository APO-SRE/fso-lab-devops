...
3.	Install [Git 2.38.1](https://git-scm.com/downloads) for Ubuntu 64-bit.  
    ```bash
    sudo apt install git
    ```

4.	Install [Packer 1.8.4](https://www.packer.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    sudo wget https://releases.hashicorp.com/packer/1.8.4/packer_1.8.4_linux_amd64.zip
    sudo unzip packer_1.8.4_linux_amd64.zip
    sudo rm -i packer_1.8.4_linux_amd64.zip
    ```

5.	Install [Terraform 1.3.4](https://www.terraform.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    ...
    sudo rm -i terraform_1.3.4_linux_amd64.zip
    ```
