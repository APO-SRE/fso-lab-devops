...
4.	Install [Packer 1.9.1](https://www.packer.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    sudo wget https://releases.hashicorp.com/packer/1.9.1/packer_1.9.1_linux_amd64.zip
    sudo unzip packer_1.9.1_linux_amd64.zip
    sudo rm -i packer_1.9.1_linux_amd64.zip
    ```

5.	Install [Terraform 1.5.2](https://www.terraform.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    ...
    sudo rm -i terraform_1.5.2_linux_amd64.zip
    ```
