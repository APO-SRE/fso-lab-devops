...
1.	Install the [Homebrew 3.4.2](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
5.	Install [Terraform 1.1.7](https://www.terraform.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    ...
    sudo rm -i terraform_1.1.7_linux_amd64.zip
    ```
