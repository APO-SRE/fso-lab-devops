...
-	Amazon AWS CLI 2.4.20 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.4.20](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.4.20 Python/3.9.10 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.4.20](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    aws --version
    # aws-cli/2.4.20 Python/3.8.8 Windows/10 exe/AMD64 prompt/off
    ```

### Windows Subsystem for Linux (WSL) installation - Ubuntu 64-Bit

1.	Install [AWS CLI 2.4.20](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	Amazon AWS EKS CLI [eksctl] 0.84.0 (command-line interface)
...
-	Python 3.7.10
	-	Pip 22.0.3
-	Serverless Framework CLI 3.3.0
-	Terraform 1.1.6
-	VIM - Vi IMproved 8.2
-	XMLStarlet 1.6.1 (command-line XML processor)
-	yq 4.20.2 (command-line YAML processor)
