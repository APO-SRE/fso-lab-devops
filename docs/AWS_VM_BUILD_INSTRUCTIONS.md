...
-	Amazon AWS CLI 2.7.21 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.7.21](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.7.21 Python/3.10.5 Darwin/21.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.7.21](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
1.	Install [AWS CLI 2.7.21](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	Amazon AWS EKS CLI [eksctl] 0.107.0 (command-line interface)
...
-	Go 1.19
-	Gradle 7.5.1
-	Helm CLI 3.9.2 (Package Manager for Kubernetes)
...
-	npm JavaScript Package Manager for Node.js 8.16.0
