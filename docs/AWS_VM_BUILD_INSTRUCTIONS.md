...
1.	Install [AWS CLI 2.4.18](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.4.18 Python/3.9.10 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.4.18](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	Amazon AWS EKS CLI [eksctl] 0.83.0 (command-line interface)
