...
1.	Install [AWS CLI 2.7.11](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	Amazon AWS EKS CLI [eksctl] 0.103.0 (command-line interface)
...
-	npm JavaScript Package Manager for Node.js 8.13.1
