...
-	Amazon AWS CLI 2.4.21 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.4.21](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.4.21 Python/3.9.10 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.4.21](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
1.	Install [AWS CLI 2.4.21](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	npm JavaScript Package Manager for Node.js 8.5.2
