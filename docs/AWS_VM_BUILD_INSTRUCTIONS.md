...
-	Amazon AWS CLI 2.5.8 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.5.8](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.5.8](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
1.	Install [AWS CLI 2.5.8](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	Amazon AWS EKS CLI [eksctl] 0.94.0 (command-line interface)
