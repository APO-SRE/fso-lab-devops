...
-	Amazon AWS CLI 2.15.1 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.15.1](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.15.1 Python/3.11.6 Darwin/23.2.0 source/arm64 prompt/off
    ```
...
1.	Install [AWS CLI 2.15.1](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    aws --version
    # aws-cli/2.15.1 Python/3.11.6 Windows/10 exe/AMD64 prompt/off
    ```

### Windows Subsystem for Linux (WSL) installation - Ubuntu 64-Bit

1.	Install [AWS CLI 2.15.1](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	Amazon AWS EKS CLI [eksctl] 0.166.0 (command-line interface)
