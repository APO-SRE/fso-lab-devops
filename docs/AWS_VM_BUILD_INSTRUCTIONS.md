...
-	Amazon AWS CLI 2.4.27 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.4.27](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.4.27 Python/3.9.10 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.4.27](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
1.	Install [AWS CLI 2.4.27](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	Amazon AWS EKS CLI [eksctl] 0.88.0 (command-line interface)
...
-	yq 4.23.1 (command-line YAML processor)
